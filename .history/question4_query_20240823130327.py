...
db_path = os.path.join(script_dir, 'wiwino/db/vivino.db')
...
csv_file_path = '/home/siegfried2021/Bureau/BeCode_AI/Projets/Wiwino_project/question4.csv'
...
with open(csv_file_path, mode='w', newline='') as file:
    ...
    # Write the header
    writer.writerow(['wine_name', 'group_name'])
